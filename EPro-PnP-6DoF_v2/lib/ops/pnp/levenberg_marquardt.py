    ...
    def solve(self, x3d, x2d, w2d, camera, cost_fun, pose_init=None, cost_init=None,
        ...
        with torch.no_grad():
            ...
            if num_obj > 0:
                ...
                if pose_init is None or force_init_solve:       # pose_init 输入的是真值
...
class RSLMSolver(LMSolver):
    ...
    def center_based_init(self, x2d, x3d, camera, eps=1e-6):
        ...
        x2dc = x2dc[..., :2] / x2dc[..., 2:].clamp(min=eps)     # 相机坐标系中的坐标x,y; (bs,num_pts,2)
        ...
        return t_vec        # 作为一个粗略的估计，为后续更精细的优化提供一个起点
